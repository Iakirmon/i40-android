...
class SummaryCalculatorTest {
    ...
    fun czasPozaPasmemKorektToSumaOdstepowNieLiczbaProbek() {
        ...
        assertEquals(9.0, make(track).czasPozaPasmemKorektSekundy)
        ...
        assertEquals(0.0, make(wPasmie).czasPozaPasmemKorektSekundy)
        assertNull(make(TrackBlob()).czasPozaPasmemKorektSekundy)
    }
